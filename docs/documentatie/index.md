...
Om de sliderplaat te laten bewegen met de stepper motor, heeft de
sliderplaat een beltholder nodig. De beltholder zorgt ervoor dat de belt
goed vast en strak zit.
...
gemaakt. Er worden ook twee klemmen gemaakt zodat deze makkelijk op de
sliderplaat geklemd kan worden. Deze beltholder was gewoon te breed en
...
Hier werd de vorige versie nog verbeterd met de afmetingen te
...
Figuur 17: Derde prototype beltholder links v3
...
gekozen kan worden en bij de sliderplaat toegevoegd kan worden.
...
Figuur 19: Eerste prototype beltholder tester v1
...
Figuur 21: Pan geprint 3D model met servo

<img src="./assets/media/image23.png" style="width:4.93889in;height:5.57097in"
alt="Afbeelding met rood Automatisch gegenereerde beschrijving" />

Figuur 22: Tilt geprint 3D model met servo

<img src="./assets/media/image24.png" style="width:5.04348in;height:4.70479in"
alt="Afbeelding met kantoorartikelen Automatisch gegenereerde beschrijving" />

Figuur 23: Gemonteerd geprint 3D model

Bovenstaande foto’s geven aan dat het gevonden 3D model goed past met de
servo motoren. Hierdoor was het niet nodig om zelf een nieuw model te
maken of aanpassingen aan te brengen.


## Elektrisch schema

Om de ESP32-CAM gemakkelijk te monteren is er een shield gemaakt. In
...
Figuur 29: Elektrische schema van ESP32-CAM shield
...
Figuur 30: PCB ESP32-CAM shield Schema

<img src="./assets/media/image32.png"
style="width:3.93686in;height:3.54792in" />

Figuur 31: PCB 3D model van ESP32-CAM shield

## Gefreesde PCB’s

### Versie 1:

Bij versie 1 was de frees machine niet zo goed gekalibreerd waardoor die
...
style="width:3.41739in;height:4.97391in" />
...
style="width:2.40997in;height:4.07826in" />
...
<img src="./assets/media/image35.png" style="width:2.45996in;height:4.26956in"
...
Het controleren van de camera, stepper motor en de servo’s gebeurt met
een interface. Daarom is er een Node-Red interface aangemaakt waar men
deze kan controleren. De huidige interface heeft alleen de manuele modus
en nog geen automatische modus.

De interface heeft twee sliders. Eén is voor de pan en de andere is voor
...
Figuur 24: Interface Pan en Tilt:

Er zijn twee modi om een foto te nemen. Eén met flits en één zonder
flits. Afhankelijk van de situatie kan men één van de twee modi kiezen.
Hieronder ziet u een voorbeeld van de interface. Er is ook een
kalibratie knop om de ESP32-CAM te kalibreren. Dit is nodig omdat er bij
...
Figuur 25: Interface van ESP32-CAM.

De foto die worden getrokken worden voorlopig opgeslagen op de lokale
server. Later wordt dat omgezet naar de bletchley server. Wanneer er een
...
Figuur 26: Foto opslag folder van de interface

De stepper motor interface heeft een optie om de slider naar links en
rechts te bewegen. Er is ook de mogelijkheid om snelheid aan te passen
...
style="width:12.77725in;height:4.03257in" />

Figuur 28: Volledige interface van de webpagina
...
Figuur 35: Error bij opstarten Docker zonder gepaste Linux kernel.

<img src="./assets/media/image37.png" style="width:6.26806in;height:3.20625in"
alt="Graphical user interface, text, application Description automatically generated" />

Figuur 36: Error bij opstarten Docker zonder activeren juiste Linux kernel
versie.

<img src="./assets/media/image38.png" style="width:6.26806in;height:3.06111in"
alt="Diagram Description automatically generated" />

Figuur 37: Diagram over hoe een image in docker wordt gemaakt.
